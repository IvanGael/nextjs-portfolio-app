...
const AnimatedGradientImageCard: React.FC<AnimatedGradientImageCardProps> = ({ content }) => {
    ...
    const closeIframe = (value : boolean) => {
        setIsIframeVisible(value);
    }
    ...
    return (
        <React.Fragment>
            ...
            {
                isIframeVisible && <IframeLoader url={content.liveLink} modalOpen={isIframeVisible} setModalOpen={closeIframe}/>
            }
        </React.Fragment>
    );
};
